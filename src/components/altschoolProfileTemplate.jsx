...
function AltschoolProfileTemplate() {
  return (
    <> <Box className="container" style={{borderRadius: "50px"}}> 
    <Box bg="blue" w="300px" h="100px" borderRadius= "10px" margin="auto" mt="20px" display="flex" flexDirection="column" justifyContent="center">
      <h1 style={{  color: "white", fontSize: "20px", textAlign: "center", paddingTop: "20px" }}>
            GitHub Repositories
          </h1>

          <Link to="src/repospages/altschoolProfileTemplate.jsx" style={{textAlign:"center", color: "white", fontSize: "20px", backgroundColor: "yellow"}} >{altschoolProfileTemplateData.name}</Link>
      </Box>
     </Box></>
  );
};
